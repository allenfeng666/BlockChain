...
const BuyModal = ({ close, buyTokens }) => {
  const styles = {
    ...
    etherscan: `w-full h-full flex items-center justify-center text-blue-500 text-2xl mt-[20px] font-bold cursor-pointer underline`,
    ...
    <div className={styles.container}>
      {isLoading ? (
        ...
        <>
          ...
          <div className={styles.title}>Buy More AllenCoins Here!</div>
